...
class ReservationsController extends Controller
{
    ...
    public function calculateTotalPrice($date_in, $date_out, $base_price)
    {
        return $date_in->diffInDays($date_out) * $base_price;
    }
    ...
    {
        $data = $reservation->load('client.profile');

        return view('admin.reservations.show')->withReservation($data);
    }
